...
>
> VI\. Doctrinal Implications 26
>
> A. Work Product and the Pro Se Litigant 26
>
> B. Unauthorized Practice of Law 28
>
> C. A Reframing, Not a Resolution 30
>
> VII\. Limitations and Future Work 30
>
> VIII\. Conclusion 33
>
> Appendix. One Assistance Architecture, Specified So It Can Be Run 35
>
...
*Source: Design properties per the multi-agent debate literature (e.g., Du et al. 2024; Liang et al. 2024; Chan et al. 2023) and, for the orchestration column, the system documentation; performance claims not independently verified.*
...
*Source: Public docket, as of June 2026. Categories reflect docket status, not any view of the merits.*

Figure 8 reproduces the docket sequence of a single day, June 4, 2026, as a primary record. It is included so that the reader can inspect the timing directly, and no inference is drawn from it. The sequence raises an empirical question, not a conclusion: what configurations of AI-assisted litigation produce records of this shape, and how often? That question belongs to the systematic study Part VII proposes.
...
*Morgan* belongs to a body of law that was forming rapidly. It was decided on March 30, 2026, the same day the joint motion to dismiss was filed in the case studied here. The two matters are unrelated and arose in different districts. The coincidence conveys only how compressed the development of AI-in-litigation doctrine was during the period the case study spans.
...
Five limits bound the design. First, and most fundamentally, this is a single case (n = 1) authored by a party to it. A single case can demonstrate that a phenomenon occurred. It cannot establish frequency, representativeness, or generality. The findings in Part V are existence claims rather than distributional ones. What such a case can do is what qualitative methodology has long recognized for extreme or revelatory cases: expose a phenomenon that standard designs have not yet reached, and generate the hypotheses that systematic study must then test.

Second, the author’s threefold role as litigant, developer and analyst is a source of bias. The author’s position, a party with a stake in the case’s outcome and the developer of the system it studies, creates a risk of favorable framing. The constraints stated in Part IV are designed to limit that risk.

Third, causation cannot be isolated. The Article documents a correlation between an orchestration architecture and quality-oriented litigation conduct, and it cannot separate the architecture’s contribution from the litigant’s own skill, prior preparation, the incentives of an unbilled party, or other confounders. The architectural discussion in Part III supplies a plausible mechanism, not a demonstrated one.

Several rival explanations remain plausible. The litigant may simply be capable: educated, motivated, and unbilled, a pro se party can spend hundreds of hours on a case that counsel would staff in tens. The three-day opposition, in particular, admits a mundane explanation, since a party who anticipates a motion can draft the response before the motion arrives, and speed of filing then measures preparation rather than processing. Selection operates at two levels. At the case level, this case is the subject of an article because its record is favorable, and cases in which orchestration-assisted litigants fail generate no articles. At the episode level the selection is the author’s own: the docket contains more events than the five this Article describes, and the author chose which to present. Against that selection, the completeness statement is docket-verifiable: as of June 2026, the record contains no order sanctioning the plaintiff, no order striking any of his filings, and no deadline he missed. The nearest the record comes to an adverse procedural note lies at the case’s threshold, where the court denied the plaintiff’s application to proceed in forma pauperis (the filing fee was then paid within the time allowed) and observed that summonses could not issue until service addresses were supplied, which they then were. The statement is falsifiable by anyone with PACER access, the only warrant a party-authored account can offer; what episode-level selection can still conceal is emphasis, not adverse rulings. None of these rivals can be excluded on the present record, and the study proposed below is designed to adjudicate among them.
...
The prevailing account of artificial intelligence in pro se litigation is a story about volume and unreliability: more litigants, filing faster, with a heightened risk of fabricated authority. It is grounded in real evidence and describes a real and common practice. But it also assumes, without saying so, that AI assistance means one litigant prompting one general-purpose model, and that assumption about architecture does not exhaust the possibilities.
...
The claim is that the architecture of AI assistance, not only its availability, belongs in the analysis of what self-represented litigants can now do. That claim only grows more pressing as foundation models converge in raw capability, because when the models themselves differ less, the way they are combined will differ more. The architecture-dependence hypothesis offered here is therefore worth systematic study: the architecture of AI assistance may be far more than an implementation detail, and it may be a substantive determinant of the quality of what people, and courts, can do. Architecture now deserves to be examined explicitly instead of being treated as incidental. Whether AI participates in legal work is no longer in question, since it demonstrably does; what remains open is which architectures of participation deserve study as distinct legal technologies. On this account the pro se AI problem is a design problem, not an intelligence problem, and design problems have design answers. The work ahead is to specify particular architectures and test them against one another instead of waiting for better individual models. The Appendix states one such architecture precisely enough to be run and criticized, and a reference implementation is published so that it can be criticised and run.
...
<img src="missing-variable/media/image9.png" style="width:6.2in;height:2.84766in" />

**Figure 9.** *The protocol by role: isolated generation, blind consolidation, and two verifications.*
...
[^1]: <sup>\*</sup> AI systems architect. The author’s roles as plaintiff, system developer, and analyst are set out in the Author’s Disclosure Statement below. Comments welcome: vadimchernets9@gmail.com.
...
[^16]: System technical documentation. These are descriptions of the system's design; the Article treats the system's own performance claims as self-reported and does not rely on them as evidence of efficacy. See Part VII.

[^17]: The architecture is the subject of a family of pending international patent applications on which the author is a named applicant; the family is documented in the public record of the litigation (see Plaintiff’s Opposition, Ex. 3), and its identifiers are omitted here as immaterial to the analysis. These are pending applications, not granted patents; patentability speaks to novelty over prior art, not to efficacy, and nothing in this Article treats the patent record as evidence of performance.
...
[^25]: For the avoidance of doubt: this Article describes only publicly filed documents and architectural features already disclosed to the defendants and the public. It deliberately withholds the specific prompts used, the system's internal decision logic on any particular question, and any draft work product, so as to minimize the risk of waiving work-product protection as to the claims still pending against the non-settling defendants.
