...
>
> **Keywords:** pro se litigation; self-represented litigants; access to justice; AI-assisted litigation; generative AI; multi-agent debate; multi-model orchestration; fabricated citations; citation verification; work-product doctrine; disclosure; standing orders; Rule 11; unauthorized practice of law; Title III; architecture-dependence hypothesis. **JEL Classification:** K41 (Litigation Process); K10 (Basic Areas of Law, General); O33 (Technological Change: Choices and Consequences).
# **Contents**
