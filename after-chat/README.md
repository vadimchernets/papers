...
agentic AI; AI agents; non-programmers; end-user programming; AI literacy; knowledge workers; technology adoption; generative AI adoption; human oversight; delegation; second-level digital divide; correlated errors; ironies of automation; deskilling; preregistration.

## Licence

Text CC BY 4.0, matching the Zenodo deposit. The SSRN copy is governed by the licence granted there. The code is MIT.
